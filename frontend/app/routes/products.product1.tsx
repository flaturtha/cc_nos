            ...
            <div className="mb-4">
              ...
              <div className="flex items-center mt-2">
                {['S', 'M', 'L', 'XL', 'XXL'].map(size => (
                  <button key={size} className="bg-gray-300 dark:bg-gray-700 text-gray-700 dark:text-white py-2 px-4 rounded-full font-bold mr-2 hover:bg-gray-400 dark:hover:bg-gray-600">
                    {size}
                  </button>
                ))}
              </div>
